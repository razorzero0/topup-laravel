            ...
            <div class="bg-white rounded ">
                ...
                <div class="flex justify-between mt-5">
                    <a href={{ route('category.index') }} type="button"
                        class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Menu
                        Kategori</a>
                    <a type="button" data-modal-target="add-product" data-modal-toggle="add-product"
                        ...
                        Produk</a>
                    @include('admin.produk.add-modal')
                </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $product)
                            <tr>
                                ...
                                <td>{{ $product['name'] }}</td>
                                <td><img class="h-10 w-auto" src="{{ asset($product->image) }}" alt="img-product"></td>

                                <td>{{ $product->category->name }}</td>
                                <td><a href="{{ route('get-item', $product['id']) }}"
                                        class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Items</a>
                                </td>
                                <td class="flex gap-1">
