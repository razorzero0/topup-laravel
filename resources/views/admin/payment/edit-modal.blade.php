<!-- Main modal -->
<div id="edit-product{{ $file['id'] }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-product{{ $file['id'] }}">
            ...
            <!-- Modal body -->
            <div class="p-3">
                <form class="space-y-4" action={{ route('files.update', $file['id']) }} method="post"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <img src="{{ asset($file['image']) }}" class="h-10 w-auto" />
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white" for="image">Ganti
                            Gambar</label>
                        <input id="image"
                    ...
                    <div>
                        <label for="" class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nama
                            Gambar</label>
