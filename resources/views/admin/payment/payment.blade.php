        ...
        <div class="p-8 bg-white border-2 rounded-lg ">
            <div class="bg-white rounded ">
                ...
                <div class="text-center ">
                    <h4 class="text-2xl text-gray-700 font-bold">Daftar Fee Payment Group</h4>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="flex gap-1">
                                    <form class="" method="post"
                                        action="{{ route('payment-channel.destroy', $payment['id']) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                ...
                <div class="text-center ">
                    <h4 class="text-2xl text-gray-700 font-bold">Daftar Payment Channel</h4>
                </div>

                <hr class="h-px my-5 bg-gray-200 border-0">
                <table id="default-table2">
                    <thead>
                        <tr>
                            <th>
                                <span class="flex items-center">
                    ...
                    <tbody>
                        ...
                        @foreach ($pay as $p)
                            <tr>
                                ...
                                <td> {{ $p['group'] }}</td>
                                <td> {{ $p['name'] }}</td>
                                <td> {{ $p['total_fee']['flat'] }}</td>
                                <td> {{ $p['total_fee']['percent'] }}</td>
