    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            @role('admin')
                ...
                <li>
                    <a href={{ route('payment-channel.index') }}
                        class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group {{ cekActive('payment-channel') }}">




                        <svg class="
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition
                            duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Payment Channel</span>
