                    ...
                    <tbody>
                        ...
                        @foreach ($data as $file)
                            <tr>
                                ...
                                <td>{{ $file['name'] }}</td>
                                <td> <img src="{{ asset($file['image']) }}" class="w-auto h-10" /></td>


                                <td class="flex gap-1">
                                    @include('admin.file.edit-modal')
                                    <button data-modal-target="edit-product{{ $file['id'] }}"
                                        data-modal-toggle="edit-product{{ $file['id'] }}"
                                    ...
                                    <form class="" method="post" action="{{ route('files.destroy', $file['id']) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
