                ...
                <div class="flex flex-col w-full gap-2 px-4 space-y-3 md:p-3 xl:p-6 dark:bg-gray-800">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between w-full ">
                            ...
                            <p class="text-base leading-4 text-gray-300 discount-percent dark:text-gray-300">-</p>
                        </div>
                        <div class="flex items-center justify-between w-full">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <p class="text-base font-semibold leading-4 text-gray-300 total dark:text-gray-300">0
                        </p>
                    </div>
                    <button id="checkoutBtn" type="button"
                        class="text-white my-5 bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-800 focus:bg-purple-950 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Beli
                        Sekarang</button>
                </div>
