        ...
        <div class="relative leading-none text-white rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
            ...
            <div class="pb-4 p-7 ">
                ...
                <div class="relative mb-3">
                    ...
                    <input type="text" id="kupon"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Masukkan Kode Kupon" />
                </div>
                <div class="flex justify-end mt-5">
                    <button id="cekKuponBtn" type="button"
                        class="text-white  -skew-x-12 bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-800 focus:bg-purple-950 font-medium  text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
                        Redem
                        Kupon</button>
                </div>
            </div>
